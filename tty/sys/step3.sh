...
goto dcend
: dcinst
echo cp sys/dc.c $1/dmr/dc.c
cp sys/dc.c $1/dmr/dc.c
: dcend
...
goto dhend
: dhinst
echo cp sys/dh.c $1/dmr/dh.c
cp sys/dh.c $1/dmr/dh.c
: dhend
...
goto dhdmend
: dhdminst
echo cp sys/dhdm.c $1/dmr/dhdm.c
cp sys/dhdm.c $1/dmr/dhdm.c
: dhdmend
...
goto klend
: klinst
echo cp sys/kl.c $1/dmr/kl.c
cp sys/kl.c $1/dmr/kl.c
: klend
...
goto ttyend
: ttyinst
echo cp sys/tty.c $1/dmr/tty.c
cp sys/tty.c $1/dmr/tty.c
: ttyend
...
goto sysentend
: sysentinst
echo cp sys/sysent.c $1/ken/sysent.c
cp sys/sysent.c $1/ken/sysent.c
: sysentend
...
goto m40end
: m40inst
echo cp sys/m40.s $1/conf/m40.s
cp sys/m40.s $1/conf/m40.s
: m40end
...
goto ttyhend
: ttyhinst
echo cp sys/tty.h $1/tty.h
cp sys/tty.h $1/tty.h
: ttyhend
exit
